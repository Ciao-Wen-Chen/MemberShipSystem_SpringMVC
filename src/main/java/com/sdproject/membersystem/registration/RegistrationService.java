...
import com.sdproject.membersystem.email.EmailSender;
import com.sdproject.membersystem.member.Member;
...
public class RegistrationService {
    ...
    public String register(RegistrationRequest request) {
        ...
        String token = memberService.signUpUser(
                new Member(
        ...
        String link = "http://localhost:3000/member/confirm?token=" + token;
        emailSender.send(
                request.getEmail(),
    ...
    public String confirmToken(String token) {
        ...
        memberService.enableMember(
                confirmationToken.getMember().getEmail());
        return "confirmed";
    }
